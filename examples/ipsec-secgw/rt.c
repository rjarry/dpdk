...
rt_init(struct socket_ctx *ctx, int32_t socket_id)
{
	...
	for (i = 0; i < nb_rt_ip6; i++) {
		...
		printf("LPM6: Adding route "
			...
			(uint16_t)((rt_ip6[i].ip.s6_addr[0] << 8) | rt_ip6[i].ip.s6_addr[1]),
			(uint16_t)((rt_ip6[i].ip.s6_addr[2] << 8) | rt_ip6[i].ip.s6_addr[3]),
			(uint16_t)((rt_ip6[i].ip.s6_addr[4] << 8) | rt_ip6[i].ip.s6_addr[5]),
			(uint16_t)((rt_ip6[i].ip.s6_addr[6] << 8) | rt_ip6[i].ip.s6_addr[7]),
			(uint16_t)((rt_ip6[i].ip.s6_addr[8] << 8) | rt_ip6[i].ip.s6_addr[9]),
			(uint16_t)((rt_ip6[i].ip.s6_addr[10] << 8) | rt_ip6[i].ip.s6_addr[11]),
			(uint16_t)((rt_ip6[i].ip.s6_addr[12] << 8) | rt_ip6[i].ip.s6_addr[13]),
			(uint16_t)((rt_ip6[i].ip.s6_addr[14] << 8) | rt_ip6[i].ip.s6_addr[15]),
