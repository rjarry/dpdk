...
test16(void)
{
	struct rte_lpm6 *lpm = NULL;
	struct rte_lpm6_config config;
	struct in6_addr ip = RTE_IPV6(0x0c0c, 0x0100, 0, 0, 0, 0, 0, 0);
	uint8_t depth = 128;
	uint32_t next_hop_add = 100, next_hop_return = 0;
	int32_t status = 0;
...
test17(void)
{
	...
	struct in6_addr ip2 = RTE_IPV6(0x8000, 0, 0, 0, 0, 0, 0, 0);
	uint8_t depth;
...
test18(void)
{
	...
	/* Add & lookup to hit invalid TBL24 entry */
	ip = (struct in6_addr)RTE_IPV6(0x8000, 0, 0, 0, 0, 0, 0, 0);
	depth = 24;
	next_hop_add = 100;
	...
	ip = (struct in6_addr)RTE_IPV6(0x8000, 0x0005, 0, 0, 0, 0, 0, 0);
	depth = 32;
	next_hop_add = 101;
	 ...
	 * entry
	 */
	ip_1 = (struct in6_addr)RTE_IPV6(0x8000, 0, 0, 0, 0, 0, 0, 0);
	depth_1 = 25;
	next_hop_add_1 = 101;

	ip_2 = (struct in6_addr)RTE_IPV6(0x8000, 0x0005, 0, 0, 0, 0, 0, 0);
	depth_2 = 32;
	next_hop_add_2 = 102;
...
test19(void)
{
	...
	ip = (struct in6_addr)RTE_IPV6(0x8000, 0x000a, 0, 0, 0, 0, 0, 0);
	depth = 32;
	next_hop_add = 101;
...
test20(void)
{
	...
	ip = (struct in6_addr)RTE_IPV6(0x8000, 0, 0, 0, 0, 0, 0, 0x000a);
	depth = 128;
	next_hop_add = 101;
...
test21(void)
{
	...
	ip_batch[0] = (struct in6_addr)RTE_IPV6(0x8000, 0, 0x0001, 0, 0, 0, 0, 0);
	depth = 48;
	next_hop_add = 100;
	...
	ip_batch[1] = (struct in6_addr)RTE_IPV6(0x8000, 0, 0x0002, 0, 0, 0, 0, 0);
	depth = 48;
	next_hop_add = 101;
	...
	ip_batch[2] = (struct in6_addr)RTE_IPV6(0x8000, 0, 0x0003, 0, 0, 0, 0, 0);
	depth = 48;
	next_hop_add = 102;
	...
	ip_batch[3] = (struct in6_addr)RTE_IPV6(0x8000, 0, 0x0004, 0, 0, 0, 0, 0);
...
test22(void)
{
	...
	ip_batch[4] = (struct in6_addr)RTE_IPV6(0x8000, 0, 0x0005, 0, 0, 0, 0, 0);
	depth[4] = 48;
	next_hop_add = 105;
	...
	ip_batch[4] = (struct in6_addr)RTE_IPV6(0x8000, 0, 0x0006, 0, 0, 0, 0, 0);
...
test26(void)
{
	struct rte_lpm6 *lpm = NULL;
	struct rte_lpm6_config config;
	struct in6_addr ip_10_32 = RTE_IPV6(0x0a0a, 0x0a02, 0, 0, 0, 0, 0, 0);
	struct in6_addr ip_10_24 = RTE_IPV6(0x0a0a, 0x0a00, 0, 0, 0, 0, 0, 0);
	struct in6_addr ip_20_25 = RTE_IPV6(0x0a0a, 0x1402, 0, 0, 0, 0, 0, 0);
...
test28(void)
{
	struct rte_lpm6 *lpm = NULL;
	struct rte_lpm6_config config;
	struct in6_addr ip = RTE_IPV6(0, 0, 0, 0, 0, 0, 0, 0);
	uint8_t depth = 16;
